...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'border-b-2 text-muted-foreground inline-flex h-9 w-fit items-center justify-center',
        className
      )}
      {...props}
    />
